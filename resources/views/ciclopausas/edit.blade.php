            ...
            <div class="card-group" >
                ...
                <div class="card" style="background-image: linear-gradient(#EAF2F8, #AAB7B8);">
                    ...
                    <br>
                      ...
                      <input type='submit' class="botonesinactivos"  value='Fin' disabled>
                  ...
                  <div class="card-bodyNew1">
                    ...
                    <div class="card-boton">
                        <div class="row">
                            ...
                            <form action="{{url('/ciclopausaout/'.$ciclosos->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                {{csrf_field()}}
                                @method('PATCH')
                                <div><input type="hidden" id="hoy" name"hoy" value="{{ $hoy }}"> </div>
                                <div><input type="hidden" id="hora" name"hora" value="{{ $hora }}"> </div>

...
<br>
                  ...
                  <div class="card" style="background-image: linear-gradient(#EAF2F8, #AAB7B8);">
                    ...
                    <div class="card-bodyNew">
                        ...
                        <br>
                        <center><img src="\theme\images\retroa.png" alt=""  width="100px" height="90px" ></center>
                        <div class="card-boton">
                            <div class="row">
                  ...
                  <div class="card-bodyNew1">
                        ...
                        <div class="card-boton">
                            <div class="row">
                                ...
                                <p class="card-text"><small class="text-muted2"><b>Tiempo de Reunion</b></b>  {{ old('timereunion', $ciclosos->timereunion)}} </small></p>
                            </div>
                        </div>
                    </div>

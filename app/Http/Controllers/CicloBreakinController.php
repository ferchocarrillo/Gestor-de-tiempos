...
class CicloBreakinController extends Controller
{
    ...
    //    $timereunion = number_format($timereunion,1,'.',',');
       ...
       // return view('ciclosalida.edit',compact('total','date3','date4','tiempoC','tiempoD','timelunch','ciclosos','date1','date2','hoy','hora','llave','user_nombre','user_cedula','timebreak'));

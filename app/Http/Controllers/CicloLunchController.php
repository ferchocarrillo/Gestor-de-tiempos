...
class CicloLunchController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('ciclolunch.edit' ,compact('ciclosos','hoy','hora','llave','user_nombre','user_cedula'));
    ...
    public function update(Request $request, $id)
    {
     ...
     return view('ciclolunchout.edit', compact('ciclosos','hoy','hora','llave','user_nombre','user_cedula'));
     //return back();
    }
